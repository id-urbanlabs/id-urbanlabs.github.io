...
{% include list.html component="card" filters="group:theme" data="themes" style="small" %}
...
{% include list.html data="citations" filters="group:feature" hideyear="true" component="citation" %}
